...
<head>
    ...
    <title>Withdraw | ArthaFlow</title>
...
<div class="page-wrapper">
    ...
    <div class="main-content">
        <div class="top-navbar">
            <div><h2 style="font-size:1rem;font-weight:700;">Withdraw Funds</h2><p style="font-size:0.78rem;color:var(--text-muted);">Transfer money from your account</p></div>
        ...
        <div class="page-content" style="max-width:540px;">
            <div class="page-header"><h1>Withdraw Funds</h1><p>Transfer money safely from your ArthaFlow account.</p></div>
            ...
            <div class="card">
                <form action="<%= request.getContextPath() %>/user/transaction" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="description" class="form-control" placeholder="E.g., ATM, Bill Payment">
                    </div>
                    <button type="submit" class="btn btn-danger btn-full" style="margin-top:0.5rem;">Confirm Withdrawal →</button>
                </form>
            </div>
        </div>
    </div>
